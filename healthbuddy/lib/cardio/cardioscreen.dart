...
import 'package:healthbuddy/cardio/cardiocontroller.dart';
import 'package:healthbuddy/musculation/Traininfo/Traininfo_screen.dart';
...
class CardioScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(create: (_) => CardioController() ,
    child: Consumer<CardioController>(builder: (context, controller, child) {
      return Scaffold(
